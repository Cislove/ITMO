...
public class StudyGroup implements Comparable<StudyGroup>{
    public StudyGroup(Long id, String name, Coordinates coordinates, LocalDate creationDate, Long studentsCount, FormOfEducation formOfEducation, Semester semesterEnum, Person groupAdmin) {
        this.id = id;
        this.name = name;
